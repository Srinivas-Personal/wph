...
Rt3Api.prototype.getRooms = function(searchParams) {
    ...
    var defaultParams = {
        ...
        locale: this.config.defaultLocale,
        currency: this.config.defaultCurrency,
        arrival_date_0: searchParams.arrival_date,
        departure_date_0: searchParams.departure_date,
        adults_0: searchParams.adults,
        children_0: searchParams.children,
